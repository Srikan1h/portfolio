...
export default function Links() {
 ...
 <ul className="flex gap-6 py-3 sm:py-0 border-neutral-700 border-b-1 sm:border-0">
  ...
  <section>
    <div className="pb-4 sm:py-5 border-b-1 border-neutral-700 ">
        ...
        <div className="grid grid-flow-row auto-rows-max">
            ...
            <Link className="flex font-mono text-sm py-2 px-3 bg-neutral-800 rounded-md m-1 justify-between" href="https://kanth.in">

        Personal Webpage <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="currentColor" className="bi bi-arrow-up-right mt-1 mx-1" viewBox="0 0 16 16">
  <path fillRule="evenodd" d="M14 2.5a.5.5 0 0 0-.5-.5h-6a.5.5 0 0 0 0 1h4.793L2.146 13.146a.5.5 0 0 0 .708.708L13 3.707V8.5a.5.5 0 0 0 1 0z"/>
</svg>


      </Link>
       <Link className="flex font-mono text-sm py-2 px-3 bg-neutral-800 rounded-md m-1 justify-between " href="https://x.com/srikan1h">
  ...
  <path fillRule="evenodd" d="M14 2.5a.5.5 0 0 0-.5-.5h-6a.5.5 0 0 0 0 1h4.793L2.146 13.146a.5.5 0 0 0 .708.708L13 3.707V8.5a.5.5 0 0 0 1 0z"/>
      ...
      <a className="flex font-mono text-sm py-2 px-3 bg-neutral-800 rounded-md m-1 justify-between" href="mailto:ss2675@srmist.edu.in">
  ...
  <path fillRule="evenodd" d="M14 2.5a.5.5 0 0 0-.5-.5h-6a.5.5 0 0 0 0 1h4.793L2.146 13.146a.5.5 0 0 0 .708.708L13 3.707V8.5a.5.5 0 0 0 1 0z"/>
            ...
            <Link className="flex font-mono text-sm py-2 px-3 bg-neutral-800 rounded-md m-1 justify-between" href="https://linkedin.com/in/saisrikanths">
  ...
  <path fillRule="evenodd" d="M14 2.5a.5.5 0 0 0-.5-.5h-6a.5.5 0 0 0 0 1h4.793L2.146 13.146a.5.5 0 0 0 .708.708L13 3.707V8.5a.5.5 0 0 0 1 0z"/>
       ...
       <Link className="flex font-mono text-sm py-2 px-3 bg-neutral-800 rounded-md m-1 justify-between " href="https://github.com/srikan1h">
